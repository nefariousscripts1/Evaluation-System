...
export default function RatingSummaryCard({
  ...
  return (
    <section className="rounded-[18px] border border-[#dddddd] bg-white p-5">
      <h2 className="text-[22px] font-extrabold text-[#24135f]">{title}</h2>

      <div className="mt-5 space-y-5">
        <ProfileInfoCard name={evaluatorName} label={evaluatorRole} />

        <div className="rounded-[12px] border border-[#e8e4f3] bg-white px-5 py-4">
          <p className="text-[14px] font-bold text-[#24135f]">Overall Rating</p>
          <div className="mt-3 flex items-center justify-between gap-4">
            <div className="text-[40px] font-extrabold leading-none text-[#24135f]">
