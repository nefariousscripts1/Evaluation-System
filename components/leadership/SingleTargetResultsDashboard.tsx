...
type SingleTargetResultsDashboardProps = {
  apiEndpoint: string;
  targetLabel: string;
...
export default function SingleTargetResultsDashboard({
  apiEndpoint,
  targetLabel,
  targetPluralLabel,
  subtitle,
    ...
    <main className="px-4 pb-4 pt-16 sm:px-5 sm:py-6">
      <div className="mx-auto max-w-[1200px] rounded-[10px] border border-[#dddddd] bg-white px-4 py-5 sm:px-8 sm:py-6">
        <div className="border-b border-[#8e8e8e] pb-4">
          ...
          <p className="mt-1 text-[13px] text-[#6c6684]">{subtitle}</p>
        </div>
        ...
        {error ? (
          ...
          <>
            <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="rounded-[12px] border border-[#e8e4f3] bg-white px-4 py-4 text-center sm:px-5">
                ...
                <p className="mt-2 text-[12px] text-[#6c6684]">
                  Across all {targetPluralLabel.toLowerCase()}
                </p>
              </div>
            ...
            <div className="mt-6 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center lg:max-w-[420px]">
